...
/** Maps com.stash.admin.event.UserForceLogoutEvent (v0.5-006). */
@Component
public class UserForceLogoutEventMapper implements EventAuditMapper {

    @Override
    public String supportedEventType() { return "UserForceLogoutEvent"; }

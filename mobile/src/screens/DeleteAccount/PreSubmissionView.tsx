    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <Animated.View entering={fadeInUp(50)}>
          <GradientHero icon="warning-outline" title="Delete your account" />
        </Animated.View>

        <Animated.View entering={fadeInUp(110)} style={styles.card}>
          <Text style={styles.paragraph}>
            Deleting your account is not immediate. When you confirm below, we start a 30-day
            waiting period. During those 30 days, your account works normally, and you can cancel
            the request at any time — there&apos;s a Cancel Request button right on this screen the
            whole time.
          </Text>

          <Text style={styles.paragraph}>
            After 30 days, if there&apos;s nothing still in progress that needs to finish first (see
            below), your account is closed: your profile data is removed, all your sessions are
            signed out, and your vault and wallet accounts are closed.
          </Text>

          <Text style={styles.paragraph}>
            Your transaction history is kept for 7 years, without your name attached, as required
            for financial record-keeping.
          </Text>

          {isLoadingBlockers ? (
            <ActivityIndicator
              style={styles.blockersLoading}
              color={colors.gold.base}
              testID="blockers-loading"
            />
          ) : blockers.length > 0 ? (
            <View style={styles.blockersBox} testID="blockers-list">
              ...
              <Text style={styles.blockersSubtitle}>
                You can still submit your deletion request. These will need to be resolved before
                the 30-day period ends, or your account will stay pending deletion until they are:
              </Text>

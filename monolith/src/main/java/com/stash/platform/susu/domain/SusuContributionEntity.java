...
public class SusuContributionEntity {
    ...
    @Column(name = "susu_round_id",  nullable = false) private UUID    susuRoundId;
    @Column(name = "susu_group_id",  nullable = false) private UUID    susuGroupId;
    @Column(name = "member_user_id", nullable = false) private UUID    memberUserId;
    @Column(name = "expected_amount",nullable = false) private long    expectedAmount;
    @Column(name = "collected_amount")                 private Long    collectedAmount;
    @Column(name = "status",         nullable = false) private String  status;
    @Column(name = "collection_attempt_count")         private int     collectionAttemptCount;
    @Column(name = "penalty_amount", nullable = false) private long    penaltyAmount;
    @Column(name = "is_late",        nullable = false) private boolean isLate;
    ...
    /** No factory method yet — rows are created when a round enters COLLECTING (v0.4-010), not this issue. */
    public SusuContributionEntity() {}

...
public class SusuRoundEntity {
    ...
    @Column(name = "scheduled_collection_at")         private Instant scheduledCollectionAt;
    @Column(name = "expected_pot_amount")             private Long    expectedPotAmount;
    @Column(name = "actual_pot_amount")               private Long    actualPotAmount;
    @Column(name = "disbursed_at")                    private Instant disbursedAt;
    @Column(name = "disbursement_transaction_id")     private UUID    disbursementTransactionId;

    /** No factory method yet — rows are created by the activation/disbursement worker (v0.4-008/010), not this issue. */
    public SusuRoundEntity() {}

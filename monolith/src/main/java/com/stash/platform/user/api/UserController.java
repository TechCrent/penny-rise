...
@Tag(name = "Users", description = "Authenticated user account management")
public class UserController {

    private final DeletionRequestService deletionRequestService;

    public UserController(DeletionRequestService deletionRequestService) {
    ...
    public ResponseEntity<DeletionRequestResponse> requestDeletion(
        ...
        return ResponseEntity.status(201).body(new DeletionRequestResponse(
                request.getId(),
                request.getStatus(),

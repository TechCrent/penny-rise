 ...
 *       as of the last poll cycle. Emitted on every poll so the dashboard
 *       shows relay lag in real time.</li>
...
public class OutboxMetrics {
    ...
    public OutboxMetrics(MeterRegistry registry) {
        ...
        this.publishedCounter = Counter.builder("outbox_events_published_total")
        ...
        this.deadLetteredCounter = Counter.builder("outbox_events_dead_lettered_total")

...
class MomoNumberValidatorTest {
    ...
    void valid_mtn_numbers_pass() {
        for (String prefix : new String[]{"024", "025", "053", "054", "055", "059"}) {
            assertThatCode(() -> MomoNumberValidator.validate("mtn", prefix + "1234567"))
    ...
    void valid_vodafone_numbers_pass() {
        for (String prefix : new String[]{"020", "050"}) {
            assertThatCode(() -> MomoNumberValidator.validate("vodafone", prefix + "1234567"))
                    .doesNotThrowAnyException();
        }
    }
    ...
    void valid_airteltigo_numbers_pass() {
        for (String prefix : new String[]{"026", "027", "056", "057"}) {
            assertThatCode(() -> MomoNumberValidator.validate("airteltigo", prefix + "1234567"))
                    .doesNotThrowAnyException();
        }
    }
    ...
    void provider_is_case_insensitive() {
        assertThatCode(() -> MomoNumberValidator.validate("MTN", "0241234567"))
                .doesNotThrowAnyException();
    }
    ...
    void number_matching_wrong_provider_is_rejected() {
        assertThatThrownBy(() -> MomoNumberValidator.validate("mtn", "0201234567"))
    ...
    void wrong_length_is_rejected() {
        assertThatThrownBy(() -> MomoNumberValidator.validate("mtn", "024123456"))
                .isInstanceOf(ResponseStatusException.class);
        assertThatThrownBy(() -> MomoNumberValidator.validate("mtn", "02412345678"))
                .isInstanceOf(ResponseStatusException.class);
    }
    ...
    void unrecognised_provider_is_rejected() {
        assertThatThrownBy(() -> MomoNumberValidator.validate("glo", "0241234567"))
                .isInstanceOf(ResponseStatusException.class)
                .satisfies(ex -> assertThat(((ResponseStatusException) ex).getStatusCode())
                        .isEqualTo(UNPROCESSABLE_ENTITY));
    }
    ...
    @Test
    @DisplayName("blank/null provider or number is rejected")
    void blank_fields_are_rejected() {
        assertThatThrownBy(() -> MomoNumberValidator.validate(null, "0241234567"))
                .isInstanceOf(ResponseStatusException.class);
        assertThatThrownBy(() -> MomoNumberValidator.validate("mtn", null))
                .isInstanceOf(ResponseStatusException.class);
        assertThatThrownBy(() -> MomoNumberValidator.validate("", "0241234567"))
                .isInstanceOf(ResponseStatusException.class);
        assertThatThrownBy(() -> MomoNumberValidator.validate("mtn", "  "))
                .isInstanceOf(ResponseStatusException.class);
    }
}
